...
const useStyles = makeStyles((theme) => ({
  mainWrapper: {
    backgroundColor: theme.palette.bordabox, //DARK MODE LEVEL10 TECH//
    display: "flex",
  ...
  newMessageBox: {
    backgroundColor: theme.palette.newmessagebox, //DARK MODE LEVEL10 TECH//
    width: "100%",
    display: "flex",
    padding: "7px",
    alignItems: "center",
  ...
  messageInputWrapper: {
    padding: 6,
    marginRight: 7,
    backgroundColor: theme.palette.inputdigita, //DARK MODE LEVEL10 TECH//
    display: "flex",
    borderRadius: 20,
    flex: 1,
  },
